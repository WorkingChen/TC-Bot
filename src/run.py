...
if __name__ == "__main__":
 parser = argparse.ArgumentParser()   
    ...
    #act_level Dia_Act&NL
    parser.add_argument('--act_level', dest='act_level', type=int, default=1, help='0 for dia_act level; 1 for NL level')
     #（DQN隐藏层层数）
    ...
    parser.add_argument('--episodes', dest='episodes', default=500, type=int, help='Total number of episodes to run (default=1)')
    ...
    parser.add_argument('--warm_start_epochs', dest='warm_start_epochs', type=int, default=120, help='the number of epochs for warm start')
    ...
    parser.add_argument('-o', '--write_model_dir', dest='write_model_dir', type=str, default='D:\\MyProject\\MiuLab-TC-Bot-master\\MiuLab-TC-Bot-master\\src\\deep_dialog\\checkpoints\\rl_agent\\', help='write model to disk') 
    parser.add_argument('--slot_err_prob', dest='slot_err_prob', default=0.00, type=float, help='the slot err probability')
    ...
    parser.add_argument('--intent_err_prob', dest='intent_err_prob', default=0.00, type=float, help='the intent err probability')  
    parser.add_argument('--batch_size', dest='batch_size', type=int, default=16, help='batch size')
    parser.add_argument('--goal_file_path', dest='goal_file_path', type=str, default='D:\\MyProject\\MiuLab-TC-Bot-master\\MiuLab-TC-Bot-master\\src\\deep_dialog\\data\\user_goals_first_turn_template.part.movie.v1.p', help='a list of user goals') 
    #seldom change params
    parser.add_argument('--dict_path', dest='dict_path', type=str, default='D:\\MyProject\\MiuLab-TC-Bot-master\\MiuLab-TC-Bot-master\\src\\deep_dialog\\data\\dicts.v3.p', help='path to the .json dictionary file')
    parser.add_argument('--movie_kb_path', dest='movie_kb_path', type=str, default='D:\\MyProject\\MiuLab-TC-Bot-master\\MiuLab-TC-Bot-master\\src\\deep_dialog\\data\\movie_kb.1k.p', help='path to the movie kb .json file')
    parser.add_argument('--act_set', dest='act_set', type=str, default='D:\\MyProject\\MiuLab-TC-Bot-master\\MiuLab-TC-Bot-master\\src\\deep_dialog\\data\\dia_acts.txt', help='path to dia act set; none for loading from labeled file')
    parser.add_argument('--slot_set', dest='slot_set', type=str, default='D:\\MyProject\\MiuLab-TC-Bot-master\\MiuLab-TC-Bot-master\\src\\deep_dialog\\data\\slot_set.txt', help='path to slot set; none for loading from labeled file')
    parser.add_argument('--diaact_nl_pairs', dest='diaact_nl_pairs', type=str, default='D:\\MyProject\\MiuLab-TC-Bot-master\\MiuLab-TC-Bot-master\\src\\deep_dialog\\data\\dia_act_nl_pairs.v6.json', help='path to the pre-defined dia_act&NL pairs')
    # load NLG & NLU model
    parser.add_argument('--nlg_model_path', dest='nlg_model_path', type=str, default='D:\\MyProject\\MiuLab-TC-Bot-master\\MiuLab-TC-Bot-master\\src\\deep_dialog\\models\\nlg\\lstm_tanh_relu_[1468202263.38]_2_0.610.p', help='path to model file')
    parser.add_argument('--nlu_model_path', dest='nlu_model_path', type=str, default='D:\\MyProject\\MiuLab-TC-Bot-master\\MiuLab-TC-Bot-master\\src\\deep_dialog\\models\\nlu\\lstm_[1468447442.91]_39_80_0.921.p', help='path to the NLU model file')       
    ...
    parser.add_argument('--learning_phase', dest='learning_phase', default='all', type=str, help='train\\test\\all; default is all')
    #parse
